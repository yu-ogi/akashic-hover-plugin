...
class HoverPlugin implements HoverPluginLike {
	...
	start(): boolean {
		...
		this.view.addEventListener("mousedown", this._onMouseOut_bound, false);
		this.view.addEventListener("pointerdown", this._onMouseOut_bound, false);
		return true;
	}
	...
	stop(): void {
		...
		this.view.removeEventListener("mousedown", this._onMouseOut_bound, false);
		this.view.removeEventListener("pointerdown", this._onMouseOut_bound, false);
	}
